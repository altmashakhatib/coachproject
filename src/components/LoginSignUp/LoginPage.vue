      ...
      <header>
       ...
       <section>
        ...
        <form @submit.prevent="submitForm">
            ...
            <p v-if="formvalid">Fill All Information Properly !</p>
            <div>
        ...
        <div>
          <p>New Users ?
          <router-link class="link" to="/login/signup">Click here!</router-link></p>
...
/* Style for form input and label */
form div {
  margin-bottom: 10px;
}
